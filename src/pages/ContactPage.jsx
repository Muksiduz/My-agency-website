...
const ContactPage = () => {
  return (
    <>
      <div
        className={`min-h-screen overflow-hidden bg-orange-100 font-sans antialiased flex items-center justify-center py-12`}>
        {/* Contact Us Section */}
        <section
          className={`  p-8 md:p-12 lg:p-30 rounded-lg text-white bg-orange-400 shadow-xl max-w-6xl mx-auto flex flex-col lg:flex-row border `}>
          {/* Left Section - Contact Form */}
          <div className="flex-1 lg:pr-12 mb-8 lg:mb-0">
            <h2 className="text-3xl md:text-5xl font-extrabold text-gray-700 mb-8">
              Get in Touch
            </h2>
          ...
          <div className="flex-1 lg:pl-12 lg:border-l-2 border-blue-300">
            ...
            <div className="space-y-6">
              <div className="flex items-center text-white">
                <svg
                  ...
                  className="h-6 w-6 text-orange-700 mr-3"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2">
            ...
            <div className="flex space-x-6 mt-8 justify-center lg:justify-start">
              ...
              <a
                href="#"
                className="text-orange-600 hover:text-orange-900 transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="currentColor"
                  viewBox="0 0 24 24">
                  <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-.008 20.25c-4.595 0-8.25-3.655-8.25-8.25s3.655-8.25 8.25-8.25 8.25 3.655 8.25 8.25-3.655 8.25-8.25 8.25zm.008-14.75c-3.584 0-6.5 2.916-6.5 6.5s2.916 6.5 6.5 6.5 6.5-2.916 6.5-6.5-2.916-6.5-6.5-6.5zm0 10.75c-2.347 0-4.25-1.903-4.25-4.25s1.903-4.25 4.25-4.25 4.25 1.903 4.25 4.25-1.903 4.25-4.25 4.25z" />
                </svg>
              </a>
              <a
                href="#"
                className="text-orange-600 hover:text-orange-900transition-colors duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="currentColor"
